...
export default {
  ...
  methods: {
    ...
    getUserInfo(){
      axios.get('https://secourse2024-675d60a0d98b.herokuapp.com/api/user-information?pk=' + localStorage.getItem('pk'))
    ...
    saveEditedInfo() {
      ...
      axios.post('https://secourse2024-675d60a0d98b.herokuapp.com/api/change-profile/', this.editedUserInfo,{withCredentials:true})
          .then(response => {
            // 处理响应
